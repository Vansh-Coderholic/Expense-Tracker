...
CATEGORIES = ['Food','Transport','Rent','Utilities','Health','Shopping']
...
def index():
    ...
    if category and category != "All":
         cat_q = cat_q.filter(Expense.category == category)
    ...
    if category and category !="All":
         day_q = day_q.filter(Expense.category == category)
